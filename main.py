"""
BlockMind — Block-level transaction intelligence with LLM tagging
...
class Router:
    """Cost- and latency-aware model router for BlockMind."""
...
if __name__ == "__main__":
    import argparse
    p = argparse.ArgumentParser(description="BlockMind: Block-level transaction intelligence with LLM tagging")
